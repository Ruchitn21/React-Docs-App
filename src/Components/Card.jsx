...
const Card = ({ data, reference }) => {
  return (
    <motion.div drag dragConstraints={ reference } whileDrag={{scale:1.2}} dragElastic={0.2} className='relative flex-shrink-0 w-60 h-80 rounded-[45px] bg-zinc-900/90 text-white px-8 py-10 overflow-hidden'>
            <FaRegFileAlt />
